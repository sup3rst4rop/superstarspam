...
async def start_yukki():
    ...
    if smex:
        ...
        try:
            ...
            await idk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await idk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await idk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await idk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if smexx:
        ...
        try:
            ...
            await ydk.start()
            await ydk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ydk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if smexxx:
        ...
        try:
            ...
            await  wdk.start()
            await wdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await wdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if smexxxx:
        ...
        try:
            ...
            await hdk.start()
            await hdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await hdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if smexxxxx:
        ...
        try:
            ...
            await sdk.start()
            await sdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await sdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if sixth:
        ...
        try:
            ...
            await adk.start()
            await adk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await adk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await adk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await adk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if seven:
        ...
        try:
            ...
            await bdk.start()
            await bdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await bdk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if ninth:
        ...
        try:
            ...
            await ddk.start()
            await ddk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ddk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if tenth:
        ...
        try:
            ...
            await edk.start()
            await edk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await edk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await edk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await edk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if eleve:
        ...
        try:
            ...
            await vkk.start()
            await vkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await vkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if twelv:
        ...
        try:
            ...
            await kkk.start()
            await kkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await kkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if thirt:
        ...
        try:
            ...
            await lkk.start()
            await lkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await lkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if forte:
        ...
        try:
            ...
            await mkk.start()
            await mkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await mkk(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if fifth:
        ...
        try:
            ...
            await sid.start()
            await sid(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await sid(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await sid(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await sid(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
    ...
    if sieee:
        ...
        try:
            ...
            await shy(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await shy(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await shy(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await shy(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if seeee:
        ...
        try:
            ...
            await aan(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await aan(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await aan(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await aan(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if eieee:
        ...
        try:
            ...
            await ake(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ake(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ake(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await ake(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if nieee:
        ...
        try:
            ...
            await eel(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await eel(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await eel(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await eel(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if gandu:
        ...
        try:
            ...
            await khu(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await khu(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await khu(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await khu(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if ekish:
        ...
        try:
            ...
            await shi(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await shi(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await shi(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await shi(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if baish:
        ...
        try:
            ...
            await yaa(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await yaa(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if teish:
        ...
        try:
            ...
            await dav(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await dav(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await dav(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await dav(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfour:
        ...
        try:
            ...
            await raj(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await raj(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await raj(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await raj(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if tfive:
        ...
        try:
            ...
            await put(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await put(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await put(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            await put(functions.channels.JoinChannelRequest(channel=" @Tsf_brand"))
            botid = telethon.utils.get_peer_id(botme)
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 6:
            ...
            try:
                ...
                await event.edit(" JAA RAHA GAND MARNE 🤤🔥")
            except Exception as e:
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 7:
            ...
            try:
                ...
                await event.edit("PRIVATE ME JAKE PELUNGA ISKO👿")
            except Exception as e:
                await event.edit(str(e))   
        else:
            await e.reply(usage, parse_mode=None, link_preview=None )
...
async def _(e):
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 11:
            ...
            text = "AJJA BETA ABB TERI MAA KO SUPERSTAR CHODEGA 🔥🥵"
    ...
    if e.sender_id in SMEX_USERS:
        ...
        if len(e.text) > 12:
            ...
            try:
                ...
                pass
            text = " JAA BSDK MAAF KIAA LEKIN BAAP KO NAAH BHULNAA 😂 😂💥"
            await e.reply(text, parse_mode=None, link_preview=None )
        elif e.reply_to_msg_id:             
            a = await e.get_reply_message()
            b = await e.client.get_entity(a.sender_id)
...
async def restart(e):
    if e.sender_id in SMEX_USERS:
        text = " JUST WAIT A MINUTE RESTARTING........\n\nPlease wait till it reboots..."
        await e.reply(text, parse_mode=None, link_preview=None )
        try:
...
text = """
CONGRATS🥳🥳🥳 YOUR FASTEST, SMOOTHEST AND POWERFUL SUPERSTAR SPAM DEPLOYED SUCCESSFULLY """

print(text)
print("")
print(" YOUR SUPERSTAR SPAM DEPLOY !!")
